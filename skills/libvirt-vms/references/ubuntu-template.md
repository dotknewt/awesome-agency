...
provider endpoint and handoff, then invoke `guest-access` by name. Before project
...
authorized Ubuntu 26.04 lifecycle smoke test described by the bundle remains
