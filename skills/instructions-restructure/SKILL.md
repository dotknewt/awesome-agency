...
If both `AGENTS.md` and a non-stub `CLAUDE.md` exist in the same directory, flag the drift and propose consolidating on `AGENTS.md` first (see `../instructions-audit/references/migration.md`). Then restructure.
