...
It rejects host-backed or stateful device XML outside the bundle's documented
...
The installed-bundle acceptance test requires the `uv` executable. It launches
